(function ($) {
  ...
  theme.AnnouncementBar = new function () {
    ...
    this.functions = {
       ...
       */
      setSectionHeight: function setSectionHeight() {
        this.section.style.height = "".concat(this.container.getBoundingClientRect().height, "px");
      } };
  ...
  $(document).ready(function () {
    ...
    var footerBlocks = document.querySelector('.footer-blocks');
    if (footerBlocks) {
